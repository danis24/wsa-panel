...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card p-3"><button class="btn btn-success btn-block  float-right">Save</button>
            </div>
            <div class="card p-3">
                <div class="row">
                    <div class="col-6">
                        <div><button class="btn btn-danger btn-block">Save As</button></div>
                    </div>
                    <div class="col-6"><button class="btn btn-warning btn-block  float-right">Load</button></div>
                </div>
            </div>
        </div>
    </div>
